...
from mpi_routines.slaves.slave_propagate_on_samples import SlavePropagateOnSamples
...
if __name__ == "__main__":
    ...
    if rank == 0:  # Master
        app = MasterMultiRoutines(slaves=range(1, size),
                                  ...
                                  prefix_follow_up_column="samples_prop",
        ...
        SlavePropagateOnSamples(work_directory=opt.work_directory,
