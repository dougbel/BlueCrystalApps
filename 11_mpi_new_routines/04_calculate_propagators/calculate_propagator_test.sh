...
srun --mpi=pmi2 python calculate_propagator.py --work_directory $WORKING_DIRECTORY --json_conf_execution_file $JSON_EXEC_FILE  --test_result_directory $TEST_RESULTS_DIR --conf_propagators_repository $JSON_PROPAGATORS_DIR