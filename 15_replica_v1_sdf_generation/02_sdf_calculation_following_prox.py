...
if __name__ == "__main__":
    ...
    # mpiexec -n 2 python comparisson/sdf_generation/02_sdf_calculation_following_prox.py --dataset_dir /media/dougbel/Tezcatlipoca/PLACE_trainings/datasets/replica_v1/scenes_downsampled  --scene apartment_1
