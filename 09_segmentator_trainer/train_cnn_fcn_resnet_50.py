...
if __name__ == "__main__":
    ...
    checkpoint_path = "/mnt/storage/home/csapo/scratch/train_cnn/checkpoints/fcn_resnet50/fcn_resnet50"
    ...
    new_model = fcn_8_resnet50(n_classes=n_classes, input_height=input_height, input_width=input_width)
    ...
    new_model.train(
        ...
        epochs=5,
        batch_size=16,
        steps_per_epoch=15194 #total number of training data points(243,109) divided by the batch size
    )
