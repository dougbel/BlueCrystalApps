...
STAGE=train
INTERACTIONS_SET=basic_human_inter
...
srun --mpi=pmi2 python generate_masks.py --scannet_analysis_dir $SCANNET_ANALYSIS_DIR --stage $STAGE --interactions_set $INTERACTIONS_SET --analysis_intersections_dir $ANALYSIS_INTERSECTIONS_DIR --output_dir $OUTPUT_DIR --analysis_intersection_percentages $ANALYSIS_INTERSECTION_PERCENTAGES
