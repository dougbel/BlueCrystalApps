...
JSON_EXEC_FILE=/mnt/storage/home/csapo/projects/05_scannet_work_distribution/02_rgb_propagation_misc/misc_testing.json

srun python registration.py --dataset_scans_path $SCANS_DIR --output_path $OUTPUT_DIR --interactions_path $TRAINED_ITER_DIR --json_conf_execution_file $JSON_EXEC_FILE
