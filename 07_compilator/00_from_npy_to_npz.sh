...
# This file was used to compress npy files to npz files to do a faster transfer if files from BC4 to my personal desktop, IT ONLY WORK WITH INFORMATION NOT GENERATED IN A PARALLEL WAY
