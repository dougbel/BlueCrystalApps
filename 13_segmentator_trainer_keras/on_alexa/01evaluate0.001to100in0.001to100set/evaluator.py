...
if __name__ == "__main__":
    ...
    checkpoint_dir = "/media/alexa/DATA/Abel/train_cnn/good_human_inter/0.001to100/checkpoints"
    weights_dir = f"{checkpoint_dir}/{interaction}/{architecture}"
    logs_dir = f"{weights_dir}/{architecture}_logs"

    test_images = "/media/alexa/DATA/Abel/train_cnn/good_human_inter/0.001to100/test_images/"
    ...
    for epoch in trange(len(l_loss_tra)):
