...
if __name__ == "__main__":
    ...
    base_dir = f"/media/alexa/DATA/Abel/train_cnn"
    ...
    test_images = f"/media/alexa/DATA/Abel/train_cnn/good_human_inter/0.001to100/test_images"
    annotated_test_images = f"/media/alexa/DATA/Abel/train_cnn/good_human_inter/0.001to100/annotation_test_images_imgs/{interaction}"

    xlsx_output = os.path.join(checkpoint_dir, f'{interaction}_{architecture}on0.001to100.xlsx')
