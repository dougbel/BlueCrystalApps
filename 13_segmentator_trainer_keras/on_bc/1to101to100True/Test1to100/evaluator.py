...
if __name__ == "__main__":
    ...
    checkpoint_dir = "/mnt/storage/home/csapo/scratch/analisys/mpi_routines/train_cnn/good_human_inter/1to100/checkpoints_ignore_background"
    weights_dir = f"{checkpoint_dir}/{interaction}/{architecture}"
    logs_dir = f"{weights_dir}/{architecture}_logs"
    test_images = "/mnt/storage/home/csapo/scratch/analisys/mpi_routines/train_cnn/good_human_inter/1to100/test_images"
    # test_images = "/mnt/storage/home/csapo/scratch/analisys/mpi_routines/train_cnn/good_human_inter/test_images/"
    annotated_test_images = f"/mnt/storage/home/csapo/scratch/analisys/mpi_routines/train_cnn/good_human_inter/1to100/annotation_test_images_imgs/{interaction}"
